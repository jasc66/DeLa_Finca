    ...
    <section className="text-gray-600 body-font">
      <div className="container px-5 py-24 mx-auto">
        <div className="flex flex-wrap mb-20">
          <h2 className="sm:text-4xl text-3xl font-bold text-white lg:w-1/3 lg:mb-0 mb-4">Nuestra Galería</h2>
          <p className="lg:pl-6 lg:w-2/3 mx-auto leading-relaxed text-base text-gray-300">
            Descubre la esencia de De La Finca a través de nuestra galería de imágenes. Cada plato es una obra maestra
            culinaria, preparada con los ingredientes más frescos y presentada con pasión. Déjate llevar por los colores
            vibrantes y las texturas tentadoras que caracterizan nuestra cocina.
          </p>
        </div>
      ...
      {selectedImage && <LightboxImage src={selectedImage} onClose={() => setSelectedImage(null)} />}
    </section>
  )
}
