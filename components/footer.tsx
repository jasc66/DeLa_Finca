...
export default function Footer() {
  ...
  return (
    <footer className="bg-black text-white py-12 relative z-20 mt-auto w-full">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/terminos-y-politicas" className="text-white/80 hover:text-white flex items-center">
